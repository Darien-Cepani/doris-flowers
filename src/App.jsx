...
const BRAND = {
  name: "DORIS",
  wordmark: "Doris Flowers",
  handle: "doris_flowers_tirane",
  instagram: "https://instagram.com/doris_flowers_tirane",
  phone: "+355 69 316 7678",
  phoneHref: "+355693167678",
  email: "orders@dorisflowers.al",
  accent: "#B79BDD",
  accentDeep: "#6F4E97",
  ink: "#322A45",
...
const LANG = {
  en: {
    ...
    visit: {
      ...
      body: "Step into Doris Flowers to choose your blooms in person, or order for same-day delivery across the city. Our florists are always happy to help you craft the perfect gift.",
    ...
    toast: {
      ...
      newsletter: "Welcome to the Doris Flowers list! 🌹",
      booking: "To place an order, please call +355 69 316 7678."
    }
  },
  sq: {
    tagline: "TRËNDAFILA & LULE",
    ...
    visit: {
      ...
      body: "Hyni në Doris Flowers për të zgjedhur lulet personalisht, ose porosisni për dërgesë brenda ditës në të gjithë qytetin. Floristët tanë janë gjithmonë të gatshëm t'ju ndihmojnë të krijoni dhuratën perfekte.",
    ...
    toast: {
      ...
      newsletter: "Mirë se vini te lista e Doris Flowers! 🌹",
      booking: "Për të porositur, ju lutemi telefononi +355 69 316 7678."
    }
  }
};
...
const PRODUCTS = [
  {
    id: 1,
    name: { en: "Stargazer Romance Bouquet", sq: "Buqetë Romantike me Zambakë Stargazer" },
    category: "bouquets",
    image: "ig/ig01.jpg",
    description: {
      en: "A lavish hand-tied bouquet of pink stargazer lilies, ivory and blush roses, peach stock, and airy gypsophila wrapped in soft tissue.",
      sq: "Një buqetë e harlisur e punuar me dorë me zambakë rozë, trëndafila fildishtë e rozë, agrostemë pjeshke dhe gypsophila, e mbështjellë me letër të butë."
    },
    details: {
      en: ["Pink, ivory & blush palette", "Generous statement size", "Same-day delivery in Tirana"],
      sq: ["Paletë rozë, fildishtë & e butë", "Madhësi mbresëlënëse", "Dërgesë brenda ditës në Tiranë"]
    }
  },
  {
    id: 2,
    name: { en: "Pink Peony Rose Basket", sq: "Shportë me Trëndafila Bozhure Rozë" },
    category: "arrangements",
    image: "ig/ig02.jpg",
    description: {
      en: "Hundreds of pink peony roses massed in a white woven basket with eucalyptus, pearl strands, and a soft pink satin bow.",
      sq: "Qindra trëndafila bozhure rozë të vendosur në një shportë të bardhë me eukalipt, vargje perlash dhe një fjongo satini rozë."
    },
    details: {
      en: ["Pink garden-rose palette", "Large statement basket", "Ideal for birthdays & gifts"],
      sq: ["Paletë trëndafilash rozë", "Shportë e madhe mbresëlënëse", "Ideale për ditëlindje & dhurata"]
    }
  },
  {
    id: 3,
    name: { en: "Red Rose Signature Box", sq: "Kuti Ekskluzive me Trëndafila të Kuq" },
    category: "roses",
    image: "ig/ig03.jpg",
    description: {
      en: "A full dome of deep red roses framed in fresh greenery and finished with a white satin bow and our gold Doris tag.",
      sq: "Një kube e plotë me trëndafila të kuq të thellë, e rrethuar me gjelbërim të freskët dhe e përfunduar me një fjongo satini të bardhë dhe etiketën tonë të artë Doris."
    },
    details: {
      en: ["Classic red roses", "Round signature flower box", "Perfect for anniversaries"],
      sq: ["Trëndafila klasikë të kuq", "Kuti e rrumbullakët me firmë", "Ideale për përvjetorë"]
    }
  },
  {
    id: 4,
    name: { en: "White Peony Grand Bouquet", sq: "Buqetë Madhështore me Bozhure të Bardha" },
    category: "bouquets",
    image: "ig/ig04.jpg",
    description: {
      en: "An opulent oversized bouquet of pure white peonies wrapped in translucent white tissue — pristine, soft, and unforgettable.",
      sq: "Një buqetë madhështore me bozhure të bardha të pastra, e mbështjellë me letër të bardhë të tejdukshme — e papërlyer, e butë dhe e paharrueshme."
    },
    details: {
      en: ["Pure white peonies", "Extra-large luxury size", "Same-day delivery in Tirana"],
      sq: ["Bozhure krejt të bardha", "Madhësi luksoze ekstra e madhe", "Dërgesë brenda ditës në Tiranë"]
    }
  },
  {
    id: 5,
    name: { en: "Magenta Peony Rose Bouquet", sq: "Buqetë me Trëndafila Bozhure Magenta" },
    category: "roses",
    image: "ig/ig05.jpg",
    description: {
      en: "A vivid hand-tied bouquet of magenta peony roses with ruffled blooms, gathered in crisp white wrap for a bold, romantic gesture.",
      sq: "Një buqetë e gjallë e punuar me dorë me trëndafila bozhure magenta, e mbledhur në mbështjellës të bardhë për një gjest të guximshëm e romantik."
    },
    details: {
      en: ["Rich magenta peony roses", "Romantic hand-tie", "Same-day delivery in Tirana"],
      sq: ["Trëndafila bozhure magenta të pasur", "Lidhje romantike me dorë", "Dërgesë brenda ditës në Tiranë"]
    }
  },
  {
    id: 6,
    name: { en: "Peach Garden Rose Trio", sq: "Trio me Trëndafila Kopshti Ngjyrë Pjeshke" },
    category: "arrangements",
    image: "ig/ig06.jpg",
    description: {
      en: "A coordinated trio of peach garden roses with eucalyptus — one wrapped bouquet and two rope-textured vases tied with pink ribbon.",
      sq: "Një trio e harmonizuar me trëndafila kopshti ngjyrë pjeshke dhe eukalipt — një buqetë e mbështjellë dhe dy vazo me litar të lidhura me fjongo rozë."
    },
    details: {
      en: ["Soft peach & apricot palette", "Rope-textured vase set", "Made to order"],
      sq: ["Paletë pjeshke & kajsie", "Set vazosh me litar", "Punuar me porosi"]
    }
  },
  {
    id: 7,
    name: { en: "Blush Spray Rose Bouquet", sq: "Buqetë me Trëndafila Spray Rozë të Butë" },
    category: "bouquets",
    image: "ig/ig07.jpg",
    description: {
      en: "A grand round bouquet of blush pink and cream spray roses, layered into a soft cloud of delicate, romantic blooms.",
      sq: "Një buqetë e madhe e rrumbullakët me trëndafila spray rozë e krem, të shtresuara në një re të butë lulesh delikate e romantike."
    },
    details: {
      en: ["Blush pink & cream spray roses", "Lush oversized dome", "Same-day delivery in Tirana"],
      sq: ["Trëndafila spray rozë & krem", "Kube e harlisur e madhe", "Dërgesë brenda ditës në Tiranë"]
    }
  },
  {
    id: 8,
    name: { en: "Long-Stem Red Rose Bunches", sq: "Tufa me Trëndafila të Kuq me Kërcell të Gjatë" },
    category: "weddings",
    image: "ig/ig08.jpg",
    description: {
      en: "Towering bunches of long-stem red roses in clear vases — a dramatic, large-scale statement for weddings, events, and grand gestures.",
      sq: "Tufa madhështore me trëndafila të kuq me kërcell të gjatë në vazo qelqi — një deklaratë dramatike për dasma, evente dhe gjeste të mëdha."
    },
    details: {
      en: ["Premium long-stem red roses", "Bulk orders for events", "Delivered across Tirana"],
      sq: ["Trëndafila premium me kërcell të gjatë", "Porosi në sasi për evente", "Dërgesë në të gjithë Tiranën"]
    }
  }
];

// Delicate floral sprig — the accent above the "doris flowers" wordmark
// (matches Brand/logo.svg). Uses currentColor so it adapts to its surroundings.
function SprigMark({ className = "" }) {
  return (
    <svg viewBox="0 0 64 64" className={className} fill="none" aria-hidden="true">
      <g stroke="currentColor" strokeWidth="2" strokeLinecap="round">
        <path d="M32 56 V 28" />
        <path d="M32 42 C 22 39 15 33 11 24" />
        <path d="M32 36 C 42 33 49 27 53 18" />
        <path d="M32 30 C 24 26 19 19 16 10" />
      </g>
      <g fill="currentColor">
        <circle className="brand-petal" cx="32" cy="20" r="3.6" />
        <circle cx="20" cy="31" r="2.6" />
        <circle cx="44" cy="27" r="2.6" />
      </g>
    </svg>
  );
}

// Doris logo — the brand's real "doris flowers" wordmark (Brand/logo.svg) rendered
// as a CSS mask so it inherits currentColor (white over the dark hero / splash /
// footer, deep plum on the light mobile menu). Size with h-/w- utilities in className.
function DorisLogo({ className = "" }) {
  return (
    <span
      role="img"
...
export default function App() {
  ...
  useEffect(() => {
    ...
    document.title = lang === "sq"
      ? "Doris Flowers — Trëndafila Luksozë, Buqeta & Lule Dasmash në Tiranë"
      : "Doris Flowers — Luxury Roses, Bouquets & Wedding Florals in Tirana";
  }, [lang]);
  ...
  return (
    <div ref={containerRef} className="relative min-h-screen font-sans antialiased text-brand-dark selection:bg-brand-gold/25 selection:text-brand-dark md:select-none bg-white overflow-x-hidden">
      ...
      >
        <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(circle at 50% 42%, rgba(183,155,221,0.18), transparent 58%)' }} />
        ...
        <div className="splash-inner relative text-center px-6">
          <DorisLogo className="splash-mark h-24 sm:h-32 w-[8.75rem] sm:w-[11.6rem] mx-auto text-white" />
      ...
      >
        ...
        <div className="lg:hidden flex items-center justify-between">
          <a href="#" onClick={() => setMobileMenuOpen(false)} className="flex items-center group leading-none">
            <DorisLogo className="h-[4.1rem] w-[6rem]" />
          </a>
          <button
        ...
        <div className="hidden lg:grid grid-cols-3 items-center">
          ...
          >
            <DorisLogo className="h-[5.25rem] w-[7.65rem] group-hover:opacity-80 transition-opacity duration-500" />
          </a>
      ...
      >
        <div className="flex items-center justify-between px-6 py-5 border-b border-brand-champagne">
          <div className="flex items-center text-brand-dark">
            <DorisLogo className="h-12 w-[4.4rem]" />
          </div>
      ...
      <section className="relative h-[100svh] min-h-[560px] overflow-hidden hero-section bg-brand-night text-white">
        ...
        >
          <source src="https://videos.pexels.com/video-files/34191039/14492438_1440_2560_29fps.mp4" type="video/mp4" />
        </video>
        ...
        <div className="relative z-20 h-full flex flex-col items-center lg:items-start justify-center text-center lg:text-left px-6 sm:px-8 md:px-12 lg:px-20">
          ...
          <div className="overflow-hidden">
            <p className="text-sm sm:text-base md:text-lg text-gray-200 font-light leading-relaxed max-w-md sm:max-w-xl mx-auto lg:mx-0 hero-animate">
              {t.hero.body}
            </p>
          </div>
          <div className="overflow-hidden mt-7 sm:mt-9 w-full">
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 sm:gap-4 hero-animate">
              <a
                href="#shop-section"
      ...
      <section className="pb-20 sm:pb-24 px-5 sm:px-4 md:px-12 max-w-7xl mx-auto bg-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5 sm:gap-6 md:gap-8">
          {[
            { span: "md:col-span-7", cat: "bouquets", img: "ig/ig04.jpg", cursor: "BOUQUETS" },
            { span: "md:col-span-5", cat: "roses", img: "ig/ig03.jpg", cursor: "ROSES" },
            { span: "md:col-span-5", cat: "arrangements", img: "ig/ig02.jpg", cursor: "ARRANGEMENTS" },
            { span: "md:col-span-7", cat: "weddings", img: "ig/ig08.jpg", cursor: "WEDDINGS" }
          ].map((c, i) => (
            <div
              key={c.cat}
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-4 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col gap-4">
            ...
            <div className="relative w-full h-[300px] sm:h-[350px] md:h-[450px] bg-brand-champagne border border-brand-champagne shadow-md overflow-hidden mt-4">
              <div id="map" role="img" aria-label="Map showing Doris Flowers in Tirana" className="w-full h-full absolute inset-0 z-10 desaturate-map" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 pb-12 sm:pb-16 border-b border-white/10">
            <div className="lg:col-span-7">
              <div className="flex flex-col">
                <DorisLogo className="h-16 w-[5.8rem] text-white" />
                <span className="text-[8px] tracking-[0.5em] text-brand-gold uppercase block mt-3 font-bold">{t.tagline}</span>
              </div>
